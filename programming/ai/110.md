...
We'll use the Iris dataset, classifying iris flower types based on their petal and sepal dimensions. It's built into Scikit-learn so we don't need download.
