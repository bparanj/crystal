For the scenario you described, where you need to modify the Caddy configuration after the domain is mapped and DNS has propagated, consider the following approach:
