...
They block DC current while allowing AC current to flow.
...
Capacitors are used in circuits that require DC blocking or transient response management. This experiment shows the importance of recognizing the distinct roles of capacitors in DC and AC circuits.
