A simple experiment to demonstrate phase shift in an inductor in Tinkercad, showing how the inductor's voltage response leads the current in an AC circuit.
