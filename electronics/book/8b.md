...
The experiment uses a polarized capacitor, where the correct polarity is a must. The capacitor's positive terminal is connected to the circuit, and its negative terminal is grounded.
