...
Connect a ? ohm resistor to the common terminal of the switch. Resistor is connected to i5 and i9 in the breadboard.

Image 6

Step 4

Connect a polaraized capacitor with ? F value in g9 and g11 in the breadboard.
