...
Reduce the voltage to 1.25 volts. LED seems to be off. Human cannot distinguish clearly whether is really on or off. The current is 0 amperes. So it cannot be in a on state.
