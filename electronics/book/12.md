...
This experiment demonstrates the principles of a voltage divider circuit and shows how voltage is distributed across components in series.

The circuit uses two resistors in series to create a voltage divider. This setup divides the total voltage of the battery (9V) across each resistor, with each resistor receiving a portion of the total voltage proportional to its resistance.
   
By placing a multimeter across each component, you can observe that the total voltage supplied by the battery is distributed among the components in series (resistors and LED). The sum of individual voltage drops approximately equals the total voltage (9V), confirming Kirchhoff’s Voltage Law.
