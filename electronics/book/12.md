...
An equivalent experiment for demonstrating the "path of least resistance" concept, but with voltage, can be created using a voltage divider circuit. This experiment will show that voltage divides according to the resistance values in series.
...
- 2 Resistors with different values (e.g., 1 kΩ and 3 kΩ)
- 2 LEDs (optional, to visualize the voltage drop across each resistor)
...
1. Set Up the Power Supply:
   ...
   - Connect the negative terminal of the battery to the ground rail.
