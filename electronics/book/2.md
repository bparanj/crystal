...
This experiment demonstrates the importance of choosing an appropriate power source and using current-limiting components (like resistors) when working with LEDs to avoid damage.
