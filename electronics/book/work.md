...
- **Raising a Book**: When you lift a book off a table, you’re doing work against gravity. Here, the force is the weight of the book, and the distance is how high you lift it.
...
1. **Energy Exchange**: While energy can be exchanged within the coffee (heat moves between the hot coffee and the cooler air trapped inside), the thermos is designed to prevent any energy from escaping to the outside environment. It’s insulated, so heat loss is minimal, and it’s sealed, preventing mass transfer.
